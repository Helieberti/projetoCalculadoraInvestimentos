...
function isObjetEmpty(obj) {
  return Object.keys(obj).length === 0;
}

function resetCharts() {
  if (
    !isObjetEmpty(doughnutChartReference) &&
    !isObjetEmpty(progressionChartReference)
  ) {
...
function validateInput(evt) {
  ...
  if (
    ...
    errorTextElement.innerText = "Insira um valor númerico maior que zero";
